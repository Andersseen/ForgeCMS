...
| [STATE.md](STATE.md) | What is implemented *right now*? What's broken/missing/next? | **Every work session** |
...
| [specs/](specs/) | Feature specs (`NNN-slug.md`, from [specs/TEMPLATE.md](specs/TEMPLATE.md)) | Per feature |
