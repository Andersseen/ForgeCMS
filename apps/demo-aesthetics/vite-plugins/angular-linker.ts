...
/**
 * Copied verbatim from `apps/www/vite-plugins/angular-linker.ts`. Every app that consumes
 * `@forge-cms/admin` needs this file, so it belongs in a shipped package (see finding 13 in
 * docs/DEMO-FINDINGS.md) — duplicated here rather than fixed, because this PR changes no package.
 *
